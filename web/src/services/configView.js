...
const SCHEMA = [
  ...
  { key: 'GROQ_API_KEY', label: 'Groq Key (LLM failover)', cat: 'AI & Voice', secret: true },
  { key: 'GROQ_MODEL', label: 'Groq Model', cat: 'AI & Voice', default: 'llama-3.3-70b-versatile' },
  { key: 'ALPHA_VANTAGE_API_KEY', label: 'Alpha Vantage Key', cat: 'Market Data', secret: true },
  { key: 'MASSIVE_API_KEY', label: 'Massive Key', cat: 'Market Data', secret: true },
  { key: 'TWELVEDATA_API_KEY', label: 'Twelve Data Key', cat: 'Market Data', secret: true },
  { key: 'EXCHANGERATE_API_KEY', label: 'ExchangeRate Key', cat: 'Market Data', secret: true },
  { key: 'LUNARCRUSH_API_KEY', label: 'LunarCrush Key', cat: 'Market Data', secret: true },
